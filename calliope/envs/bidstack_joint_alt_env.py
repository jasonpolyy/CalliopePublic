...
class MeritOrderJointNEMEnv(gym.Env):
    ...
    def step(self, action):
        ...
        arbitrage_indicator_reward = bess_energy_rescale*abs_diff_scalar*((discharge_indicator*(bess_gen_rreg_util_rescale/eta_d))+(charge_indicator*eta_c*bess_load_lreg_util_rescale)) 

...
class MeritOrderJointNEMEnv(gym.Env):
    ...
    def __init__(
        ...
        # FCAS participations
        fcas_actions_low = [0,0]
        fcas_actions_high = [MAX_BESS_FCAS_RREG,MAX_BESS_FCAS_LREG]
    ...
    def step(self, action):
        ...
        charge, discharge, rreg, lreg = action#[0]
        ...
        bids_all = [q_energy_bid,q_rreg,q_lreg]     
        ...
        bess_dispatched_all = [get_bess_dispatch(m) for m in MARKETS_REG]

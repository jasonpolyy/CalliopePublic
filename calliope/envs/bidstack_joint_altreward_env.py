...
class MeritOrderJointNEMEnv(gym.Env):
    ...
    def step(self, action):
        ...
        arbitrage = region_price*bess_energy_rescale*((bess_gen_rreg_util/eta_d)-(eta_c*bess_load_lreg_util)) 
        ...
        arbitrage_indicator_reward = BETA*bess_energy_rescale*abs_diff_scalar*((discharge_indicator*bess_gen_rreg_util/eta_d)+(charge_indicator*eta_c*bess_load_lreg_util)) 

        # reward 
        reward = arbitrage + arbitrage_indicator_reward + fcas_revenue #+ soc_violation
